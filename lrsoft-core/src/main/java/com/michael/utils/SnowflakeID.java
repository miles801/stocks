...
public class SnowflakeID {
    ...
    private final static Logger logger = Logger.getLogger(SnowflakeID.class);
    ...
    private static SnowflakeID flowIdWorker = new SnowflakeID(1);
    ...
    public static void main(String[] args) throws Exception {
        ...
        SnowflakeID idWorker = SnowflakeID.getInstance();
