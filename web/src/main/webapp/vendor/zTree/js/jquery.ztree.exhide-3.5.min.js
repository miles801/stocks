 ...
 */
(function (i) {
    i.extend(!0, i.fn.zTree._z, {view: {clearOldFirstNode: function (c, a) {
        ...
        var b, e, g, f, h;
        for (e = 0, g = a.length; e < g; e++)if (b = a[e], !f && !b.isHidden &&
            b.isFirstNode) {
            f = b;
            break
        ...
        var b, e, g, f;
        for (e = a.length - 1; e >= 0; e--)if (b = a[e], !g && !b.isHidden &&
            b.isLastNode) {
            g = b;
            break
        ...
        return{"new": g, old: f}
    }}, data: {initHideForExCheck: function (c, a) {
