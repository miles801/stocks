...
(function (window, angular, $) {
    var app = angular.module('stock.stock.stock.edit', [
        'eccrm.angular',
        'eccrm.angularstrap',
        'stock.stock.stock'
    ]);
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, StockService, StockParam) {
        ...
        $scope.save = function (createNew) {
            var promise = StockService.save($scope.beans, function (data) {
        ...
        $scope.update = function () {
            var promise = StockService.update($scope.beans, function (data) {
        ...
        $scope.load = function (id, callback) {
            var promise = StockService.get({id: id}, function (data) {
