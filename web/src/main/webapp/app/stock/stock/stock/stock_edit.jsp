...
<body>
<div class="main" ng-app="stock.stock.stock.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
...
<script type="text/javascript" src="<%=contextPath%>/app/stock/stock/stock/stock_edit.js"></script>
</html>