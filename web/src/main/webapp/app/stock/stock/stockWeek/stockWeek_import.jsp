...
<body>
<div class="main" ng-app="stock.stock.stockWeek.import" ng-controller="Ctrl">
    <div class="block">
...
<script type="text/javascript" src="<%=contextPath%>/app//stock/stock/stockWeek/stockWeek_import.js"></script>
</html>
