...
<body>
<div class="main" ng-app="stock.stock.stockWeek.edit" ng-controller="Ctrl" style="overflow: auto;">
    <div class="block">
                ...
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="row float">
                        ...
                        <div class="item w300">
                            ...
                            <div class="w200 pr">
                                <input type="text" class="w200" ng-model="beans.businessDate" eccrm-my97="{}" readonly
                                       placeholder="点击选择日期"/>
                                <span class="add-on"><i class="icons icon clock" ng-click="beans.businessDate=null"
                                                        title="点击清除日期"></i></span>
                            </div>
                        </div>
                        <div class="item w300">
                            ...
                            <input type="text" class="w200" ng-model="beans.key" validate validate-required
                                   maxlength="10"/>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=contextPath%>/app/stock/stock/stockWeek/stockWeek_edit.js"></script>
</html>