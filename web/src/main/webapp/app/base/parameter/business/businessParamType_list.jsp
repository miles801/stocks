...
<head >
    ...
    <script type="text/javascript" src="<%=contextPath%>/static/wanda/javascript/wanda-comm.js" ></script >
    <script >
...
<body >
<div class="main condition-row-1" ng-app="base.parameter.type.list"
     ng-controller="ParameterTypeListController">
                ...
                <div class="table-responsive panel panel-table first-min" >
                    <table class="table table-striped table-hover" >
                        ...
                        <tr ng-repeat="foo in parameters.data " >
                            ...
                            <td title="点击查询明细！" class="detail" ng-click="view(foo.id)" > {{ foo.name}}</td >
                            <td ng-bind-template="{{ foo.code }}" ></td >
                            <td ng-bind-template="{{ foo.parentName }}" ></td >
                            <td ng-bind-template="{{ foo.status | parameterStatus}}" ></td >
                            <td >
...
<script type="text/javascript" src="<%=contextPath%>/app/base/parameter/business-param-modal.js" ></script >
<script type="text/javascript" src="<%=contextPath%>/app/base/parameter/business/businessParamType_list.js" ></script >
</html >
