...
<body >
<div class="main condition-row-1" ng-app="eccrm.im.news.read" ng-controller="Ctrl" >
...
<script type="text/javascript" src="<%=contextPath%>/app/base/im/news/news_read.js" ></script >
</body >
</html >